...
extern const ::google::protobuf::internal::ClassDataLite<35> LoginResponse_class_data_;
}  // namespace Stc
}  // namespace RatkiniaProtocol
namespace google {
namespace protobuf {
...
PROTOBUF_ALWAYS_INLINE void LoginResponse::set_failure_reason(Arg_&& arg, Args_... args) {
  ::google::protobuf::internal::TSanWrite(&_impl_);
  _impl_._has_bits_[0] |= 0x00000001u;
...
inline std::string* PROTOBUF_NONNULL LoginResponse::mutable_failure_reason()
    ABSL_ATTRIBUTE_LIFETIME_BOUND {
...
inline std::string* PROTOBUF_NONNULL LoginResponse::_internal_mutable_failure_reason() {
  ::google::protobuf::internal::TSanWrite(&_impl_);
  _impl_._has_bits_[0] |= 0x00000001u;
  return _impl_.failure_reason_.Mutable( GetArena());
}
inline std::string* PROTOBUF_NULLABLE LoginResponse::release_failure_reason() {
  ::google::protobuf::internal::TSanWrite(&_impl_);
...
inline void LoginResponse::set_allocated_failure_reason(std::string* PROTOBUF_NULLABLE value) {
  ::google::protobuf::internal::TSanWrite(&_impl_);
  if (value != nullptr) {
    _impl_._has_bits_[0] |= 0x00000001u;
  } else {
