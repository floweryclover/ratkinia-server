...
inline PROTOBUF_NDEBUG_INLINE LoginResponse::Impl_::Impl_(
    ...
    const Impl_& from, const ::RatkiniaProtocol::Stc::LoginResponse& from_msg)
...
const ::google::protobuf::internal::ClassDataLite<35> LoginResponse::_class_data_ = {
    {
...
const ::_pbi::TcParseTable<1, 2, 0, 57, 2> LoginResponse::_table_ = {
  {
